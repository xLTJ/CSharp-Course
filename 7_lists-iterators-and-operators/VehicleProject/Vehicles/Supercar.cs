...
{
    public override int MaxSpeed { get; } = Rand.Next(200, 301);
    public override int MaxEnergy { get; } = Rand.Next(60, 81);
    public override int AccelerateSpeedIncrement { get; } = Rand.Next(25, 41);
    public override int DecelerateSpeedDecrement { get; } = Rand.Next(35, 51);
    public override int CoastingSpeedDecrement { get; } = Rand.Next(4, 8);
    public override int EnergyConsumptionRate { get; } = Rand.Next(9, 14);
