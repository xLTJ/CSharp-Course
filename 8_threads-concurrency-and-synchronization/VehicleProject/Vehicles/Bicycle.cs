...
{
    public override int MaxSpeed { get; set; } = Rand.Next(25, 46);
    public override int MaxEnergy { get; set; } = Rand.Next(40, 61);
    public override int AccelerateSpeedIncrement { get; set; } = Rand.Next(4, 8);
    public override int DecelerateSpeedDecrement { get; set; } = Rand.Next(6, 11);
    public override int CoastingSpeedDecrement { get; set; } = Rand.Next(1, 3);
    public override int EnergyConsumptionRate { get; set; } = Rand.Next(2, 4);
